...
module.exports = {
  ...
  tailwindThemeFormatter: {
    ...
    createTailwindThemeFont: ({ dictionary }) => {
  		const theme = {};
  		dictionary.allTokens.forEach(token => {
    ...
    createTailwindThemeFontSize: ({ dictionary }) => {
  		const theme = {};
  		dictionary.allTokens.forEach(token => {
  			setWith(
  				theme,
    ...
    createTailwindThemeFontWeight: ({ dictionary }) => {
  		const theme = {};
  		dictionary.allTokens.forEach(token => {
  			setWith(
  				theme,
    ...
    createTailwindThemeLineHeight: ({ dictionary }) => {
  		const theme = {};
  		dictionary.allTokens.forEach(token => {
  			setWith(
  				theme,
    ...
    createTailwindThemeFontFamily: ({ dictionary }) => {
  		const theme = {};
  		dictionary.allTokens.forEach(token => {
  			setWith(
  				theme,
